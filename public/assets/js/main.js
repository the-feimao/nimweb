    ...
    var imJs = {
        ...
        vedioActivation: function (e) {
          $('#play-video, .play-video').on('click', function (e) {
              ...
              $("#video-overlay, .video-overlay").append('<iframe width="640" height="360" src=" https://youtube.com/embed/MaULPcFPEAI?t=1118   " title="The President &amp; Chairman of Council, Dr. Mrs. Christiana V.N Atako, FNIM in a Chat with NIM Media" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
